const projectsData = [
  ...
  // },
  {
    ...
    description: `This demo uses your camera to get live stream and tracks your poses in real-time. It works on laptops, iPhones and android phones.`,
    imgSrc: '/static/images/pose-estimation.png',
    techs: ['python', 'web', 'tensorflow'],
    href: '/apps/pose-estimation-from-webcam/index.html',
  },
  // {
  ...
  // },
  {
    ...
    description: `This demo uses your camera to get live stream and segments the detected people in real-time. It works on laptops, iPhones and android phones.`,
    imgSrc: '/static/images/body-segmentation.png',
    techs: ['python', 'web', 'tensorflow'],
    href: '/apps/body-segmentation-from-webcam/index.html',
  },
]
